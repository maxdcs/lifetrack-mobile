  ...
  return (
    <>
      ...
      <Tabs screenOptions={screenOptions}>
        ...
        <Tabs.Screen name="auth/login" options={{ tabBarButton: () => null, tabBarStyle: { display: 'none' } }} />
        <Tabs.Screen name="auth/register" options={{ tabBarButton: () => null, tabBarStyle: { display: 'none' } }} />
      </Tabs>
    </>
  );
}
